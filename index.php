...
<body>
    ...
    <div id="core_fullbox" class="fade-in">
        ...
        <div id="mainsite">
            ...
            <div id="slideshow" class="fade-in">
              <div id="overflow">
                ...
                <div class="inner">
                  ...
                  <div <?php post_class('slide fade-in slidepost_' . $slidecounter); ?> id="post-<?php the_ID(); ?>">
                    ...
                    <div class="postmeta" class="fade-in">
                      <div class="date"><?php the_date() ?></div>
                      <?php the_category() ?>
                    </div>
                    <div class="postmain">
                      <h3 class="title" class="fade-in"><?php the_title() ?></h3>
                      <?php the_excerpt() ?>
                    </div>
                    <div
                      class="imgplane" class="fade-in" style="background-image: url(<?php echo get_the_post_thumbnail_url(get_the_ID(),'medium') ?>); background-size: cover; background-repeat: no-repeat; background-position: center;">
                    </div>
                    <div class="catbox fade-in"></div>
                  </div>
                  <?php endwhile; ?>
            ...
            <div id="postbox" class="fade-in">
                <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
                <div id="post-<?php the_ID(); ?>" <?php post_class('index brick fade-in index_post'); ?>>
